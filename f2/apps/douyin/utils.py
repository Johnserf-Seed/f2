...
class TokenManager:
    ...
    token_conf = f2_manager.get_config("msToken").get("douyin", None)
    ttwid_conf = f2_manager.get_config("ttwid").get("douyin", None)
    proxies_conf = f2_manager.get_config("proxies").get("douyin", None)
    proxies = {
